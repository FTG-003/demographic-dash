...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-1.4-brightgreen.svg?style=for-the-badge" alt="Version 1.4">
...
```
                  ...
                  │  (Dashboard client)   │     Chart.js 4.4
                  └───────────────────────┘     CountUp.js 2.8
```

| Livello | Tecnologia | Ruolo |
|---|---|---|
| **Frontend** | HTML5 + Vanilla JS + CSS3 | Single-page application (~2100 righe) |
...
demographic-dash/
│
├── index.html                  # Dashboard completa (single-file, ~2100 righe)
